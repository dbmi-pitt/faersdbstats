...
COPY eu_drug_name_active_ingredient FROM 'EU_registered_drugs_by_active_ingredient_utf8.csv' WITH DELIMITER E'\t' CSV HEADER QUOTE E'"' NULL AS 'null'; --NULL AS 'null' has not be tested
