#!/bin/bash
# /home/pentaho-secondary/projects-brb265-2024/faersdbstats/faersdbstats/stage_4_domain_logging/generate_wc_l_import_file_reac.sh
source ../../faers_config.config

# Base directory for all years of data
BASE_FILE_DIR="$BASE_FILE_DIR/data_from_s3/faers/reac"

# Output file for all years
OUTPUT_DIR="$BASE_FILE_DIR/qa"
OUTPUT_FILE="$OUTPUT_DIR/reac_wc_import.psv"
