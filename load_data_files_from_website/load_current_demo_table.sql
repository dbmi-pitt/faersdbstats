...
COPY demo_staging_version_A FROM '/job/faersdbstats/load_data_files_from_website/ascii/all_version_A_demo_data_with_filename.txt' WITH DELIMITER E'$' CSV HEADER QUOTE E'\b' ;
