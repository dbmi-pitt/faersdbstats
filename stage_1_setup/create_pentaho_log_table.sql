...
ALTER TABLE ${DATABASE_LOG_SCHEMA}.pdi_logging ADD COLUMN "RESULT_KTL" VARCHAR(5);
...
CREATE INDEX IF NOT EXISTS "IDX_${DATABASE_LOG_NAME}_2" ON ${DATABASE_LOG_SCHEMA}.pdi_logging(TRANSNAME, LOG_DATE);
