run_date=$(date "+%m%d%Y")
DB_BACKUP_FILENAME="${DATABASE_NAME}_${LOG_FILENAME_ROOT}_stg_1_auto_bk_fcd_${run_date}.dump"
DB_BACKUP_FILENAME_FCD="${DATABASE_NAME}_${LOG_FILENAME_ROOT}_stg_1_auto_bk_fcd_${run_date}.dump"
