        ...
        # echo outer loop pwd is `pwd`
            ...
            for domain in reac; do #demo drug indi outc reac rpsr ther; do
                ...
                #blow out old staged files
                    ...
                    #     rm $file
                    # done;
                    # for file in ./**/*_staged_with_lfs_only_new_header.txt; do
                    #     echo 'about to rm '"$file"
                    #     rm $file
                    # done;
                ...
                for name in ./**/*_staged_with_lfs_only.txt; do
                    ...
                    if [[ "${#thefilename}" -gt 24 ]]; then 
                        ...
                        #add thefilenamedata ie $DEMO12Q4.txt$12$q4
                        ...
                        if [ $headempty = 0 ]; then
                            ...
                            #replace first occurence of $thefilenamedata to make header
